...
Partial Class FrmGerente
    ...
    Private Sub InitializeComponent()
        ...
        ' btnRegistro
        ' 
        btnRegistro.Location = New Point(19, 28)
        ...
        ' btnReservaciones
        ' 
        btnReservaciones.Location = New Point(20, 446)
        ...
        ' btnMesita
        ' 
        btnMesita.Location = New Point(142, 234)
        ...
        ' btnFactura
        ' 
        btnFactura.Location = New Point(142, 28)
        ...
        ' btonPedido
        ' 
        btonPedido.Location = New Point(19, 336)
        ...
        ' btnClient
        ' 
        btnClient.Location = New Point(19, 131)
        ...
        ' btnProducto
        ' 
        btnProducto.Location = New Point(143, 131)
        ...
        ' BtnCocina
        ' 
        BtnCocina.Location = New Point(19, 234)
