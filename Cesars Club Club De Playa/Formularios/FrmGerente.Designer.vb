...
Partial Class FrmGerente
    ...
    Private Sub InitializeComponent()
        ...
        ' btnReservaciones
        ' 
        btnReservaciones.Location = New Point(555, 139)
        ...
        ' btnMesita
        ' 
        btnMesita.Location = New Point(555, 35)
        ...
        ' btnFactura
        ' 
        btnFactura.Location = New Point(684, 35)
        ...
        ' btonPedido
        ' 
        btonPedido.Location = New Point(431, 35)
        ...
        ' btnClient
        ' 
        btnClient.Location = New Point(12, 139)
        ...
        ' btnProducto
        ' 
        btnProducto.Location = New Point(684, 138)
